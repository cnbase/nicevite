        ...
        <a-layout-header :style="{ padding: '0 10px' }">
            ...
            <div style="display: flex;justify-content: flex-end;">
                <div :style="{ lineHeight: '64px', marginLeft: '10px', textAlign: 'center' }">
                    ...
                    <a-dropdown>
                        <a class="ant-dropdown-link" style="margin-left: 5px;color: #fff;font-weight: bold;" @click.prevent>
                            游客,你好
                            <DownOutlined />
                        </a>
                        <template #overlay>
...
import { PieChartOutlined, DesktopOutlined, UserOutlined, TeamOutlined, FileOutlined, DownOutlined } from '@ant-design/icons-vue';
